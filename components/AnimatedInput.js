  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        onFocus={handleFocus}
        onBlur={handleBlur}
        className={`w-full bg-transparent border-0 border-b border-gray-400 py-2 text-gray-700 focus:outline-none focus:border-[#2B3F6C] transition-colors duration-200 ${className}`}
        style={{ 
          outline: 'none', 
          boxShadow: 'none', 
          borderBottom: isFocused ? '1px solid #2B3F6C !important' : '1px solid #9CA3AF !important',
          ...style 
        }}
        {...props}
      />
